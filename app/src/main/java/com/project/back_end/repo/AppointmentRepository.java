...
public interface AppointmentRepository extends JpaRepository<Appointment, Long> {
    ...
    // Find appointments for a doctor within a time range (with doctor availability)
    ...
    // Filter by doctor ID, partial patient name (case-insensitive), and time range
    ...
    // Filter by partial doctor name, patient ID, and status
